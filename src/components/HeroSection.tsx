  ...
  return (
    <section className="lg:py-32 py-28 bg-[#39089D] text-center">
      ...
      >
        ...
        <p className="mt-6 lg:text-lg text-sm sm:text-xl text-purple-100 max-w-3xl mx-aut">
        </p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link
            href="/start"
            className="inline-block bg-lime-400 hover:bg-lime-500 text-black font-bold rounded-full lg:px-8 px-6 lg:py-3 py-2 lg:text-lg text-base transition-colors"
          >
            Start
          </Link>
        </motion.div>
